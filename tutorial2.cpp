...
int main()
{
  ...
  // 2.Print the content of the vector on screen
  // 2b.Printe the content in the reverse order.
  ...
  // 6.Find the smallest element min()
  // 7.Find the largest element max()
